...
public class s_HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void sendUserToLoginActivity(){
        ...
        Intent loginIntent = new Intent(s_HomeActivity.this, LoginActivity.class);
