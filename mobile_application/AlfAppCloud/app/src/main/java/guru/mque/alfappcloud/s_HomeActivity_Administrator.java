...
public class s_HomeActivity_Administrator extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void sendUserToLoginActivity(){
        ...
        Intent loginIntent = new Intent(s_HomeActivity_Administrator.this, LoginActivity.class);
